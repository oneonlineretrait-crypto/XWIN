...
import { PaiementIndisponible } from './pages/PaiementIndisponible'
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/paiement-indisponible" element={<ProtectedRoute><PaiementIndisponible /></ProtectedRoute>} />
