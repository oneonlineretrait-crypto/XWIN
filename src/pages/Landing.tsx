  ...
  return (
    <div className="min-h-screen xwin-radial-bg">
      ...
      <header className="px-4 sm:px-6 py-4 flex items-center justify-between max-w-5xl mx-auto">
        ...
        <Link
          to="/auth"
          className="text-sm text-paper/70 hover:text-paper border border-white/15 px-4 py-2 rounded-full transition-colors"
        >
          Se connecter
        </Link>
      </header>
      ...
      <section className="px-6 pt-10 pb-16 max-w-3xl mx-auto text-center">
        ...
        <p className="text-paper/60 text-base sm:text-lg mb-8 max-w-xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            to="/auth"
            className="w-full sm:w-auto text-paper/70 hover:text-paper px-8 py-3.5 rounded-full border border-white/15 transition-colors"
          >
            J'ai déjà un compte
          </Link>
        </div>
        ...
        {stats && stats.rate !== null && (
          <div className="mt-10 inline-flex items-center gap-6 border border-white/10 rounded-2xl px-6 py-4">
            <div>
              <p className="text-2xl font-display text-signal">{stats.rate}%</p>
              <p className="text-xs text-paper/50">de réussite</p>
            </div>
            <div className="w-px h-8 bg-white/10" />
            <div>
              <p className="text-2xl font-display">{stats.won}</p>
              <p className="text-xs text-paper/50">pronos gagnés</p>
            </div>
            <div className="w-px h-8 bg-white/10" />
            <div>
              <p className="text-2xl font-display">{stats.won + stats.lost}</p>
              <p className="text-xs text-paper/50">au total</p>
            </div>
          </div>
        )}
      </section>
      ...
      <section className="px-6 py-16 border-t border-white/10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div className="border border-white/10 rounded-2xl p-6 flex-1 max-w-xs mx-auto">
              <p className="text-paper/50 text-sm mb-1">Hebdomadaire</p>
            ...
            <div className="border border-gold/40 rounded-2xl p-6 flex-1 max-w-xs mx-auto">
              <p className="text-paper/50 text-sm mb-1">Mensuel</p>
      ...
      {/* Footer */}
      <footer className="px-6 py-8 border-t border-white/10 text-center text-xs text-paper/40 space-y-2">
